...
public class SpeechToTextService {
     ...
     */
    public Observable<SpeechToTextConversionData>    getSpeechToTextObservable(final SpeechToTextConversionData speechToTextConversionData) {
    ...
    private Observable<SpeechToTextConversionData> updateRealmObservable(SpeechToTextConversionData speechToTextConversionData, Context context) {
        Observable<SpeechToTextConversionData> observable = Observable.create(new ObservableOnSubscribe<SpeechToTextConversionData>() {
            @Override
            public void subscribe(@io.reactivex.annotations.NonNull ObservableEmitter<SpeechToTextConversionData> emitter) throws Exception {
    ...
    public void createDriveService() throws GeneralSecurityException, IOException {
        ...
        Drive service = new Drive.Builder(HTTP_TRANSPORT, JacksonFactory.getDefaultInstance(), getCredentials(HTTP_TRANSPORT))
                .setApplicationName(context.getString(R.string.audio_to_text))
                .build();
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = SpeechToTextService.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
