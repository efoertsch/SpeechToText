...
public class AudioPlaybackActivityModule {
    ...
    @Provides
    public AudioPlaybackViewModel providesAudioPlaybackViewModel(AudioPlaybackActivity activity, @Singleton AudioService audioService, @Singleton AudioRecordUtils audioRecordUtils) {
        return new AudioPlaybackViewModel(activity, audioService, audioRecordUtils);
    }
